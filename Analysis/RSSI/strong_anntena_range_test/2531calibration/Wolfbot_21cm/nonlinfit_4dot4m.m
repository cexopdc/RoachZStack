...
exportfig(gcf,'rssi_dis_fit_4.4m.eps'...
...
%dlmwrite('rssi_dis_fitting.txt', rssi_dis_fitting, 'delimiter','\t');
...
set(gca, 'FontSize', 18, 'LineWidth', 2);
exportfig(gcf,'rssi_dis_fit_weighted_4.4m.eps'...
    ,'height',6,'Width',8,'fontmode','Scaled', 'color', 'rgb');
...
std3 = input(:,3);
rssi_dis_fitting = [x3 y3 std3];
%dlmwrite('rssi_dis_weighted_fitting.txt', rssi_dis_fitting, 'delimiter','\t');
