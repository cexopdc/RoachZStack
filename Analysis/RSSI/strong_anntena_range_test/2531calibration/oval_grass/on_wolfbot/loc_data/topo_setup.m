...
for i=6:15
    Node(i).helper_node.est_x = 0;
    Node(i).helper_node.est_y = 0;
    Node(i).helper_node.cov = 0;
    Node(i).helper_node.dis = 0;
    Node(i).helper_node.dis_std = 0;
end
...
Node(6).cov = [STD_INITIAL^2 0;0 STD_INITIAL^2];
...
Node(7).cov = [STD_INITIAL^2 0;0 STD_INITIAL^2];
...
Node(8).cov = [STD_INITIAL^2 0;0 STD_INITIAL^2];
...
Node(9).cov = [STD_INITIAL^2 0;0 STD_INITIAL^2];
...
Node(10).cov = [STD_INITIAL^2 0;0 STD_INITIAL^2];
...
Node(11).cov = [STD_INITIAL^2 0;0 STD_INITIAL^2];
...
Node(12).cov = [STD_INITIAL^2 0;0 STD_INITIAL^2];
...
Node(13).cov = [STD_INITIAL^2 0;0 STD_INITIAL^2];
...
Node(14).cov = [STD_INITIAL^2 0;0 STD_INITIAL^2];
...
Node(15).cov = [STD_INITIAL^2 0;0 STD_INITIAL^2];
