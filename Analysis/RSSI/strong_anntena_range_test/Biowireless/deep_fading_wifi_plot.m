...
cd /Users/hongxiong/Documents/RoachZStack/Analysis/RSSI/strong_anntena_range_test/2531calibration/Angle/Small_fading_test/outdoor/wifi/;
mean_rssi_3 = [];
for i=0:1:8
    input = load(strcat('1m_90degree_pos_',num2str(i),'.txt'));
    input = input(1:500,:);
...
cd /Users/hongxiong/Documents/RoachZStack/Analysis/RSSI/strong_anntena_range_test/2531calibration/Angle/Small_fading_test/grass/low/wifi;
mean_rssi_4 = [];
for i=0:1:8
    input = load(strcat('1m_90degree_pos_',num2str(i),'.txt'));
    input = input(1:500,:);
...
% cd /Users/hongxiong/Documents/RoachZStack/Analysis/RSSI/strong_anntena_range_test/2531calibration/Angle/Small_fading_test/grass/high/wifi;
% mean_rssi_5 = [];
% for i=0:1:8
%     input = load(strcat('1m_90degree_pos_',num2str(i),'.txt'));
%     input = input(1:500,:);
...
exportfig(gcf,'/Users/hongxiong/Documents/roachzstack/analysis/rssi/strong_anntena_range_test/Biowireless/deep_fading_wifi_plot_with_grass.eps'...
