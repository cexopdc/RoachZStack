...
for i=start_point:20:end_point % number of nodes
    ...
    for j=1:num_trials % number of trials
        [average_loc_error_array,coverage,avg_connectivity] = main_CRLB_ONLY(i,100,20,0.2,0.2);
...
save num_node_20_to_200_30trials_CRLB_ONLY.mat; % Remember to change the file name
