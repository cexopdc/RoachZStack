clear all;
load('flop_results/FLOP_trans_range_10_to_50_50trials_no_stage.mat')
...
%{
mat_obj = matfile('flop_results/FLOP_trans_range_10_to_50_50trials_no_stage.mat','Writable',true);
...
abs_error_matrix = [];
for i = x
    abs_error_matrix = [abs_error_matrix error_matrix(:,i/10)*i];
end
plot(x,abs_error_matrix);
%}
figure;    
x = start_point:10:end_point;
...
set(hAx,'XTick',10:10:50);
set(hAx, 'box', 'on')
exportfig(gcf,'flop_results/trans_range_10_to_50_mean_comparison_no_stage.eps','height',6,'Width',8,'fontmode','Scaled', 'color', 'rgb');
...
set(gca,'XTick',10:10:50,'xlim',[10 50]);
set(gca, 'FontSize', 16, 'LineWidth', 2);
set(findall(gcf,'-property','FontSize'),'FontSize',16);
set(gca, 'box', 'on')
exportfig(gcf,'flop_results/trans_range_10_to_50_std_comparison_no_stage.eps','height',6,'Width',8,'fontmode','Scaled', 'color', 'rgb');
...
%}
exportfig(gcf,'flop_results/trans_range_10_to_50_flop_comparison_no_stage.eps','height',6,'Width',8,'fontmode','Scaled', 'color', 'rgb','LockAxes',0);
...
set(gca, 'FontSize', 16, 'LineWidth', 2);
set(gca, 'box', 'on')
exportfig(gcf,'flop_results/trans_range_10_to_50_stage_comparison_no_stage.eps','height',6,'Width',8,'fontmode','Scaled', 'color', 'rgb');
...
set(gca, 'FontSize', 16, 'LineWidth', 2);
set(gca, 'box', 'on')
exportfig(gcf,'flop_results/trans_range_10_to_50_msg_comparison_no_stage.eps','height',6,'Width',8,'fontmode','Scaled', 'color', 'rgb');
...
set(gca, 'FontSize', 16, 'LineWidth', 2);
set(gca, 'box', 'on')
exportfig(gcf,'flop_results/trans_range_10_to_50_bytes_comparison_no_stage.eps','height',6,'Width',8,'fontmode','Scaled', 'color', 'rgb');
