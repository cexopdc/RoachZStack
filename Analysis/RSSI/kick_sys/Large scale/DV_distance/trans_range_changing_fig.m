clear all;
load('STD_trans_range_10_to_50_50trials.mat')
%mat_obj = matfile('STD_trans_range_10_to_50_50trials.mat','Writable',true);
...
for i=1:m
    for j=1:n
        ...
        if aggregate_error_matrix(i,j)>2.5
            aggregate_error_matrix(i,j) = 2.5;    %%%%%%%%%%%
        end
    end
end
