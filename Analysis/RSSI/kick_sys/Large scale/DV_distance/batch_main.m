...
for i=1:num_trials
    fprintf('i=%f\n',i);
    [average_loc_error_array,std_loc_error_array,coverage,avg_connectivity] = main_CRLB_ONLY(100,100,20,0.2,0.2); %%%%%%%%%
...
save batch_main_100node_100trials_CRLB_ONLY.mat; % Remember to change the file name
