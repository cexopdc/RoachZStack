...
for i=start_point:10:end_point % number of nodes
    ...
    for j=1:num_trials % number of trials
        [average_loc_error_array,coverage,avg_connectivity] = main_CRLB_ONLY(100,100,i,0.2,0.2);  %%%%%%%%%%%
    ...
    error_matrix = [error_matrix;mean(nonzeros(aggregate_error(:,1)))]; 
...
save trans_range_10_to_50_50trials_CRLB_ONLY.mat; % Remember to change the file name
