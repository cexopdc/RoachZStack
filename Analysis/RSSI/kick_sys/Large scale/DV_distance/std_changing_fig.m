clear all;
load('STD_std_0.05_to_0.5_100nodes_100trials.mat');

%mat_obj = matfile('STD_std_0.05_to_0.5_100nodes_50trials_CRLB_ONLY.mat','Writable',true);
