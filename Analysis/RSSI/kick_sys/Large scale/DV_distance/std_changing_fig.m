clear all;
load('flop_results/FLOP_std_0.05_to_0.5_100nodes_50trials_no_stage.mat')
...
mat_obj = matfile('flop_results/FLOP_std_0.05_to_0.5_100nodes_50trials_no_stage.mat','Writable',true);
...
set(hAx,'XTick',0.05:0.05:0.50);
set(hAx, 'box', 'on')
exportfig(gcf,'flop_results/std_0.05_to_0.5_mean_comparison_no_stage.eps','height',6,'Width',8,'fontmode','Scaled', 'color', 'rgb');
...
set(gca,'XTick',0.05:0.05:0.50,'xlim',[0.05 0.50]);
set(gca,'YTick',0:0.2:2);
set(gca, 'FontSize', 16, 'LineWidth', 2);
set(findall(gcf,'-property','FontSize'),'FontSize',16);
set(gca, 'box', 'on')
exportfig(gcf,'flop_results/std_0.05_to_0.5_std_comparison_no_stage.eps','height',6,'Width',8,'fontmode','Scaled', 'color', 'rgb');
...
%}
exportfig(gcf,'flop_results/std_0.05_to_0.5_flop_comparison_no_stage.eps','height',6,'Width',8,'fontmode','Scaled', 'color', 'rgb','LockAxes',0);
...
set(gca, 'FontSize', 16, 'LineWidth', 2);
set(gca, 'box', 'on')
exportfig(gcf,'flop_results/std_0.05_to_0.5_stage_comparison_no_stage.eps','height',6,'Width',8,'fontmode','Scaled', 'color', 'rgb');
...
set(gca, 'FontSize', 16, 'LineWidth', 2);
set(gca, 'box', 'on')
exportfig(gcf,'flop_results/std_0.05_to_0.5_msg_comparison_no_stage.eps','height',6,'Width',8,'fontmode','Scaled', 'color', 'rgb');
...
set(gca, 'FontSize', 16, 'LineWidth', 2);
set(gca, 'box', 'on')
exportfig(gcf,'flop_results/std_0.05_to_0.5_bytes_comparison_no_stage.eps','height',6,'Width',8,'fontmode','Scaled', 'color', 'rgb');
