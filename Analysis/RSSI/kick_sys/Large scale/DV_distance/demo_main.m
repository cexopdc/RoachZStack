...
clear all; close all;
rng default;
rng (9); %9,13,16,18,19,20,24,26,27,30
global Length;
...
drawnow;
 ...
 %output = strcat('myMovie_',num2str(seed),'.mat');
 %save(output,'myMovie');
save('myMovie_19.mat','myMovie');
%message = sprintf('Done creating movie\nDo you want to play it?');
%button = questdlg(message, 'Continue?', 'Yes', 'No', 'Yes');
drawnow;	% Refresh screen to get rid of dialog box remnants.
%print(strcat('myMovie_',num2str(seed)),'-dpng')
close(hFigure);
movie2avi(myMovie,'/Users/hongxiong/Desktop/demo2_KI.avi','fps',2,'quality',100)
%{
