function transmiteStimulate(COM,pinCombo, posOnTime, posOffTime, negOnTime, negOffTime, stimCycleCount, silenceTime,totalCycleCount)
COM
port = serial(COM,'BaudRate',115200);
fopen(port);
