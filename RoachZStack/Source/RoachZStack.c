...
const SimpleDescriptionFormat_t RoachZStack_SimpleDesc =
{
  ...
  ROACHZSTACK_MAX_CLUSTERS,          //  byte  AppNumInClusters;
  (cId_t *)RoachZStack_ClusterList,  //  byte *pAppInClusterList;
  ROACHZSTACK_MAX_CLUSTERS,          //  byte  AppNumOutClusters;
  (cId_t *)RoachZStack_ClusterList   //  byte *pAppOutClusterList;
};
